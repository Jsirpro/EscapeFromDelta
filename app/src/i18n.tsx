...
export const copy = {
  en: {
    ...
    play: {
      ...
      buyArmorPoint: "Buy +1.0 Armor",
      buyWeaponPoint: "Buy +1.0 Weapon",
      loadoutPurchasePrice: "1000 EDcoins each",
  ...
  zh: {
    ...
    play: {
      ...
      startCost: "开局消耗",
      buyArmorPoint: "购买 +1.0 护甲",
      buyWeaponPoint: "购买 +1.0 武器",
      loadoutPurchasePrice: "每次 1000 EDcoins",
